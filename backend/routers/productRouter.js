...
productRouter.post('/', isAuth, isAdmin, isSeller, isSellerOrAdmin, expressAsyncHandler(async(req, res) => {
...
productRouter.put('/:id', isAuth, isAdmin, isSeller, isSellerOrAdmin, expressAsyncHandler(async (req, res) => {
