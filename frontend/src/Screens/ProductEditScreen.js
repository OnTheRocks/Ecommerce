...
export default function ProductEditScreen(props) {
  ...
  const uploadFileHandler = async (e) => {
    ...
    try {
      const {data} = await Axios.post('/api/images', bodyFormData, {
    ...
    <div>
      <form className="form" onSubmit={submitHandler}>
        ...
        <>          
          ...
          <div>
            <label htmlFor="countInStock">Count</label>
            <input id="countInStock" type="text" placeholder="Enter Count" value={countInStock} onChange={(e) => setCountInStock(e.target.value)}>          
            </input>
          </div>
          <div>
